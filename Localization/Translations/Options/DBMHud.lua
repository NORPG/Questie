...
local dbmHudOptionsLocales = {
    ...
    ["Toggles whether or not available/complete quest icons appear on the HUD. (Default: %s)"] = {
        ...
        ["esES"] = "Activa o desactiva si los iconos de misiones disponibles/completadas aparecen en el HUD. (Predeterminado: %s)",
        ["esMX"] = "Activa o desactiva si los iconos de misiones disponibles/completadas aparecen en el HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes de quêtes disponibles / terminées apparaissent sur le HUD. (Par défaut : %s)",
    ...
    ["Toggles whether or not object (gear) icons appear on the HUD. (Default: %s)"] = {
        ...
        ["esES"] = "Activa o desactiva si los iconos de objetos (equipo) aparecen en el HUD. (Predeterminado: %s)",
        ["esMX"] = "Activa o desactiva si los iconos de objetos (equipo) aparecen en el HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes d'objets (équipement) apparaissent sur le HUD. (Par défaut : %s)",
        ...
        ["zhCN"] = "切换是否在 DBM HUD 上显示物件（装备）图标。（默认：%s）",
        ["zhTW"] = "切換是否在 DBM HUD 上顯示物件（裝備）圖示。（預設：%s）",
    },
    ["Size & Scale Options"] = {
        ["enUS"] = true,
    ...
    ["Toggles whether or not loot icons appear on the HUD. (Default: %s)"] = {
        ...
        ["esES"] = "Activa o desactiva si los iconos de botín aparecen en el HUD. (Predeterminado: %s)",
        ["esMX"] = "Activa o desactiva si los iconos de botín aparecen en el HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes de butin apparaissent sur le HUD. (Par défaut : %s)",
    ...
    ["Toggles whether or not slay icons appear on the HUD. (Default: %s)"] = {
        ...
        ["esES"] = "Activa o desactiva si los iconos de matanza aparecen en el HUD. (Predeterminado: %s)",
        ["esMX"] = "Activa o desactiva si los iconos de matanza aparecen en el HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes de tuerie apparaissent sur le HUD. (Par défaut : %s)",
